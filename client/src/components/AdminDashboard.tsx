...
const AdminDashboard: React.FC = () => {
  ...
  const getTrendData = () => {
    ...
    if (monthlyStats.length < 2)
      return {
        appointments: { percentage: 0, isPositive: true },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center">
          ...
          <p className="text-yellow-600 mb-4">
            No analytics data found. Please try refreshing.
          </p>
          <button
            onClick={handleManualRefresh}
            disabled={refreshing}
      ...
      <div className="mb-8 flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">
            Monitor your healthcare platform performance
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="text-center">
            ...
            <span className="text-lg font-bold text-gray-900">
              {formatIndianNumber(analytics.totalDoctors || 0)}
            </span>
          </div>
          <div className="text-center">
            <div className="flex items-center justify-center mb-2">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
          ...
          <div className="space-y-4">
            {Object.entries(analytics.specialityStats || {}).length ? (
              Object.entries(analytics.specialityStats).map(
                ([specialization, count], index) => {
                  const percentage =
                    ((count as number) / (analytics.totalDoctors || 1)) * 100;
                  return (
